...
const App = () => {
  ...
  const dragEnd = (e) => {
    ...
    const squareBeingDraggeddId = parseInt(squareBeingDragged.getAttribute('data-id'))
    const squareBeingReplacedId = parseInt(squareBeingReplaced.getAttribute('data-id'))

    currentColorArrangement[squareBeingReplacedId] = squareBeingDragged.getAttribute('src')
    currentColorArrangement[squareBeingDraggeddId] = squareBeingReplaced.getAttribute('src')
    ...
    if(squareBeingReplacedId && validMove && (isARowOfThree || isARowOfFour || isAColumnOfFour || isAColumnOfThree)){
      ...
      currentColorArrangement[squareBeingDraggeddId] = squareBeingDragged.getAttribute('src')
